...
export const SET_COURIER = 'features/Transaction/SET_COURIER';
export const SET_PRICE = 'features/Transaction/SET_PRICE';
export const SET_DATE = 'features/Transaction/SET_DATE';
export const SET_NOTIF = 'features/Transaction/SET_NOTIF';